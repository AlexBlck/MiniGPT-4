...
@registry.register_builder("mets")
class MetsCaptionBuilder(BaseDatasetBuilder):
...
@registry.register_builder("magicbrushchain")
class MBCaptionBuilder(BaseDatasetBuilder):
    train_dataset_cls = MagicBrushChain

    DATASET_CONFIG_DICT = {"default": "configs/datasets/magicbrushchain/caption.yaml"}
...
@registry.register_builder("spotdiff")
class SpotDiffBuilder(BaseDatasetBuilder):
    train_dataset_cls = SpotDiffDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/spotdiff/caption.yaml"}
